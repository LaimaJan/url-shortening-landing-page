...
export default function BottomContent() {
	return (
		<section className="BottomContent">
			...
			<hr></hr>
			<div className="company-detailed-info">
				<article>
					<div className="article-container">
						...
						<p className="article-heading">Brand Recognition</p>
						<p className="article-info">
							Boost your brand recognition with each click. Generic links
							don&lsquo;t mean a thing. Branded links help instil confidence in
							vour content.
						</p>
					</div>
				</article>
				<article>
					<div className="article-container">
						...
						<p className="article-heading">Detailed Records</p>
						<p className="article-info">
				...
				<article>
					<div className="article-container">
						...
						<p className="article-heading">Fully Customizable</p>
						<p className="article-info">
							Improve brand awareness anc content discoverability through
